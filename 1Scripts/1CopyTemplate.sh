...
case $1 in
  Makefile) cp $templatesDir/1Files/5Makefile $1;;
  *) case "${1##*.}" in
<<<<<<< HEAD
       ...
       py)  cp $templatesDir/1Files/4.py $1;chmod 700 $1;vim $1;;
=======
       c) cp $templatesDir/1Files/1.c $1;vim $1;;
       sh) cp $templatesDir/1Files/2.sh $1;chmod 700 $1;vim $1;;
       hs) cp $templatesDir/1Files/3.hs $1;vim $1;;
       py) cp $templatesDir/1Files/4.py $1;vim $1;;
>>>>>>> 63f3943818ba093f4aee5a759f10dba6fe7a80ab
